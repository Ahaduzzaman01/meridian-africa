...
class Meridian_Africa_System_Architecture_Solution_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'System Architecture Solution', 'meridian-africa' );
	}
	...
	public function get_keywords() {
		return array( 'solution', 'architecture', 'system', 'meridian', 'sentinel' );
	}
	...
	private function register_content_controls() {
		...
		$this->start_controls_section(
			'title_section',
			array(
				'label' => esc_html__( 'Title & Description', 'meridian-africa' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			)
		);
		...
		$cards_repeater->add_control(
			...
			array(
				...
				'options' => array(
					'verified-card'    => esc_html__( 'Verified', 'meridian-africa' ),
					'scalable-card'    => esc_html__( 'Scalable', 'meridian-africa' ),
					'continuous-card'  => esc_html__( 'Continuous', 'meridian-africa' ),
					'transparent-card' => esc_html__( 'Transparent', 'meridian-africa' ),
				),
			)
		);
