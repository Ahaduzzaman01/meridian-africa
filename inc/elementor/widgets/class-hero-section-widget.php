...
class Meridian_Africa_Hero_Section_Widget extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'hero', 'banner', 'header', 'home', 'meridian' );
	}
			...
			<div class="container hero-container">
				<div class="hero-content">
					...
					<div class="hero-buttons">
						<a href="<?php echo esc_url( $settings['primary_button_link'] ); ?>" class="btn-primary btn-large btn-glow">
							<span><?php echo esc_html( $settings['primary_button_text'] ); ?></span>
							<i class="fas fa-arrow-right"></i>
						</a>
						<a href="<?php echo esc_url( $settings['secondary_button_link'] ); ?>" class="btn-secondary btn-large">
