<?php
/**
 * Elementor Contact Breadcrumb Widget
 *
...
class Meridian_Africa_Contact_Breadcrumb_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'meridian-contact-breadcrumb';
	}
	...
	public function get_title() {
		return esc_html__( 'Contact Breadcrumb', 'meridian-africa' );
	}
	...
	public function get_keywords() {
		return array( 'breadcrumb', 'navigation', 'contact', 'path', 'meridian' );
	}
...
// Register the widget
Plugin::instance()->widgets_manager->register( new Meridian_Africa_Contact_Breadcrumb_Widget() );
