...
if( !function_exists('kristo_post_tags')){
	
	function kristo_post_tags() {
...
// ----------------------------------------------------------------------------------------
function kristo_video_embed($url){
...
if(!function_exists('kristo_theme_post_navigation')) {
  function kristo_theme_post_navigation() { 
        ...
        <div class="theme_blog_Nav post_nav_Left <?php echo (empty($prev_thumbnail)) ? 'no-thumb':''; ?>">
          ...
          <div class="theme_blog_nav_Inner">
            <div class="theme_blog_nav_Label">
				...
				<?php $blog_prev_title = kristo_get_option('blog_prev_title');  ?>
      ...
      <div class="<?php echo esc_attr($col_class); ?>">
        ...
        <div class="theme_blog_Nav post_nav_Right <?php echo (empty($next_post_thumbnail)) ? 'no-thumb':''; ?>">
          ...
          <div class="theme_blog_Inner">
			...
			<?php $blog_next_title = kristo_get_option('blog_next_title');  ?>
...
function kristo_user_contact_methods( $user_contact ) {
	
    $user_contact['facebook']   = esc_html__( 'Facebook Profile Link', 'kristo' );
    $user_contact['twitter']    = esc_html__( 'Twitter Profile', 'kristo' );
    $user_contact['instagram']  = esc_html__( 'Instagram', 'kristo' ); 
	$user_contact['pinterest']  = esc_html__( 'Pinterest', 'kristo' );
	$user_contact['youtube']    = esc_html__( 'Youtube Profile', 'kristo' );
	
    return $user_contact; 
};
add_filter( 'user_contactmethods', 'kristo_user_contact_methods' );

function kristo_theme_author_box() {
    ...
    $theme_author_markup .= '<h6 class="theme_author_Title">' . esc_html__('About Author', 'kristo'). '</h6>';
...
function kristo_categories_postcount_filter ($variable) {
   $variable = str_replace('(', '<span class="post_count"> ', $variable);
   $variable = str_replace(')', ' </span>', $variable);
   return $variable;
}
add_filter('wp_list_categories','kristo_categories_postcount_filter');
