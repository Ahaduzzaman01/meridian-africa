...
<header id="theme-header-two" class="theme_header__main header-style-one header-style-two <?php if( $theme_header_sticky == true ) { echo "stick-top"; } else { echo "stick-disable"; } ?>">
		...
		<div class="container">
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-4 col-md-12">
					...
					<?php if($kristo_header_social == true) : ?>
					
					<div class="htop_social">
					
					<?php 
						if ( ! empty( $kristo_social_icon ) ) : 
						foreach( $kristo_social_icon as $item ) :
					?>
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-12 col-md-12 nav-design-one">
