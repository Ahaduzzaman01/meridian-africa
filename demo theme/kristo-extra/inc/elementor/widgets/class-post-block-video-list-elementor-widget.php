...
class kristo_post_block_video_list extends Widget_Base {
	...
	public function get_name() {
		return 'kristo-post-block-video-list';
	}
	...
	public function get_title() {
		return esc_html__( 'Post Block Video List', 'kristo-extra' );
	}
	...
	public function get_keywords() {
		return [ 'kristo', 'post', 'video', 'widget', 'elementor', 'list', 'block' ];
	}
    ...
    private function layout_options() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .tab-bottom-grid-style.post-list-block-wrapper .tab-small-thumbnail-wrap' => 'max-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tab-bottom-grid-style.post-list-block-wrapper .tab-small-thumbnail-wrap a img' => 'height: {{SIZE}}{{UNIT}};',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tab-small-thumbnail-wrap a img' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
    ...
    */
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              'name' => 'block_onelist_title_typography',
              'label' => esc_html__( 'Post Title Typography', 'kristo-extra' ),
              'selector' => '{{WRAPPER}} .tab-bottom-grid-style.post-list-block-wrapper .tab-post-grid-content-small h3.post-title',
           ]
        );		
		...
		$this->add_group_control(
           \Elementor\Group_Control_Typography::get_type(),
           [
              'name' => 'block_onelist_excerpt_typography',
              'label' => esc_html__( 'Post Excerpt Typography', 'kristo-extra' ),
              'selector' => '{{WRAPPER}} .tab-bottom-grid-style.post-list-block-wrapper .tab-post-grid-content-small .post-excerpt-box p',
           ]
        );	
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} #post_block_list.tab-bottom-grid-style.post-list-block-wrapper .tab-post-grid-content-small h3.post-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
				'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} #post_block_list.tab-bottom-grid-style.post-list-block-wrapper .tab-post-grid-content-small h3.post-title a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
				'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} #post_block_list.tab-bottom-grid-style.post-list-block-wrapper .post-excerpt-box' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
				'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} #post_block_list.tab-bottom-grid-style.post-list-block-wrapper .post-excerpt-box p' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
				'separator' => 'before',
            ]
        );
	...
	protected function render() {
		...
		<?php if ( $query->have_posts() ) : ?>
			...
			<?php while ($query->have_posts()) : $query->the_post(); ?>
							...
							<div id="post_block_list_video" class="tab-small-list-item tab-bottom-grid-style post-list-block-wrapper video_list_posts">
...
Plugin::instance()->widgets_manager->register_widget_type( new kristo_post_block_video_list() );