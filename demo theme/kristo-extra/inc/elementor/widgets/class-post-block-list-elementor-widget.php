...
class kristo_post_block_list extends Widget_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Post Block List', 'kristo-extra');
    }
    ...
    {
        return ['kristo', 'post', 'kristo post', 'widget', 'elementor', 'list', 'block'];
    }
    ...
    protected function render()
    {
		...
		<?php if ($query->have_posts()): ?>
			...
			<?php while ($query->have_posts()): $query->the_post();?>
				<div id="post_block_list" class="tab-small-list-item tab-bottom-grid-style post-list-block-wrapper wow fadeInUp delay-0-4s">
...
Plugin::instance()->widgets_manager->register_widget_type(new kristo_post_block_list());