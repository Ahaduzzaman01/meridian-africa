...
class kristo_post_block_item extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Block Item', 'kristo-extra' );
	}
    ...
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} #video_large_post.blog-post-tab-wrap.post-block-item.post-block-item-one .post-excerpt-box p',
           ]
        );	
	...
	protected function render() {
		...
		<?php if ( $query->have_posts() ) : ?>
			...
			<?php while ($query->have_posts()) : $query->the_post(); ?>
				...
				<div id="video_large_post" class="blog-post-tab-wrap post-block-item post-block-item-one wow fadeInUp delay-0-2s">
...
Plugin::instance()->widgets_manager->register_widget_type( new kristo_post_block_item() );