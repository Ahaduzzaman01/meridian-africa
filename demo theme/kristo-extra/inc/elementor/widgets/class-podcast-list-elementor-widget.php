...
class podcast_list extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Podcast List', 'kristo-extra' );
	}
	...
	public function get_keywords() {
		return [ 'kristo', 'post', 'kristo post', 'widget', 'elementor', 'podcast', 'list' ];
	}
    ...
    */
	...
	protected function render() {
		...
		<?php if ( $query->have_posts() ) : ?>
			...
			<style>
				.podcast-list .tab-small-post-list {
					display: flex;
					gap: 18px;
				}

				.post-list-block-wrapper.post-list-block-wrapper-loadmore.podcast-list .tab-small-thumbnail-wrap {
					margin-left: 00px;
				}

				.podcast-list .tab-small-thumbnail-wrap {
					max-width: 100%;
				}

				.podcast-list .tab-small-thumbnail-wrap img {
					height: 304px !important;
				}

				.podcast-list .slider-category-box.tab-cat-box {
					margin-bottom: 20px;
				}

				.podcast-list .post-excerpt p {
				...
				.podcast-list .post-excerpt {
					margin-bottom: 38px;
				}

				.podcast-list .tab-post-grid-content-small {
					position: relative;
				}

				.podcast-list .wave-audio-wrapper{
					position: absolute;
					bottom: 0;
					left: 0;
					width: 100%;
				...
				@media (max-width: 575px) {
					...
					.podcast-list .tab-small-post-list.postlist-loadmore-item .tab-post-grid-content-small {
						margin-bottom: 0px;
					}
				}
				...
				@media (max-width: 480px) {
					...
					.podcast-list .slider-category-box a {
						margin-right: 0px;
						margin-bottom: 0px;
					}
				...
				<div id="post_block_list_loadmore" class="tab-small-list-item tab-bottom-grid-style post-list-block-wrapper post-list-block-wrapper-loadmore podcast-list wow fadeInUp delay-0-2s">
...
Plugin::instance()->widgets_manager->register_widget_type( new podcast_list() );