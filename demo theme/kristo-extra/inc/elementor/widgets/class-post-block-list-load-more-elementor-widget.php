...
class kristo_post_block_list_loadmore extends Widget_Base {
	...
	public function get_name() {
		return 'posts-block-list-loadmore';
	}
	...
	public function get_title() {
		return esc_html__( 'Post Block List Loadmore', 'kristo-extra' );
	}
	...
	public function get_keywords() {
		return [ 'kristo', 'post', 'kristo post', 'widget', 'elementor', 'load more', 'more', 'list' ];
	}
    ...
    private function layout_options() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tab-bottom-grid-style.post-list-block-wrapper.post-list-block-wrapper-loadmore .tab-small-thumbnail-wrap a img' => 'height: {{SIZE}}{{UNIT}};',
				],
		...
		$this->add_responsive_control(
			'post_img_radius',
			[
				'label' =>esc_html__( 'Set Post Image Border Radius', 'liberk-extra' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
				...
				'selectors' => [
					'{{WRAPPER}} .tab-bottom-grid-style.post-list-block-wrapper.post-list-block-wrapper-loadmore .tab-small-thumbnail-wrap a img' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
    ...
    */
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              'name' => 'block_list_lmore_title_typography',
              'label' => esc_html__( 'Post Title Typography', 'kristo-extra' ),
              'selector' => '{{WRAPPER}} .post-list-block-wrapper.post-list-block-wrapper-loadmore .tab-post-grid-content-small h3.post-title',
           ]
        );
		...
		$this->add_group_control(
           \Elementor\Group_Control_Typography::get_type(),
           [
              'name' => 'block_list_lmore_excerpt_typography',
              'label' => esc_html__( 'Post Excerpt Typography', 'kristo-extra' ),
              'selector' => '{{WRAPPER}} .post-list-block-wrapper.post-list-block-wrapper-loadmore .post-excerpt-box p',
           ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .post-list-block-wrapper.post-list-block-wrapper-loadmore .tab-post-grid-content-small h3.post-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .post-list-block-wrapper.post-list-block-wrapper-loadmore .tab-post-grid-content-small h3.post-title a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
				'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .post-list-block-wrapper.post-list-block-wrapper-loadmore .post-excerpt-box p' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
				'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .post-list-block-wrapper.post-list-block-wrapper-loadmore .post-excerpt-box p' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
				'separator' => 'before',
            ]
        );
	...
	protected function render() {
		...
		<?php if ( $query->have_posts() ) : ?>
			...
			<?php while ($query->have_posts()) : $query->the_post(); ?>
							...
							<div id="post_block_list_loadmore" class="tab-small-list-item tab-bottom-grid-style post-list-block-wrapper post-list-block-wrapper-loadmore wow fadeInUp delay-0-2s">
...
Plugin::instance()->widgets_manager->register_widget_type( new kristo_post_block_list_loadmore() );